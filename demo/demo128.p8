...
main {
    extsub @bank 128 $A006 = name128() -> str @AY
    extsub @bank 128 $A009 = number128() -> ubyte @A
    extsub @bank 128 $A00c = multiply128(ubyte arg0 @A, ubyte arg1 @Y, uword arg2 @R15)
    extsub @bank 128 $A00f = args128(ubyte arg0 @A, ubyte arg1 @X, ubyte arg2 @Y) -> ubyte @A, ubyte @X, ubyte @Y

    extsub @bank 155 $A006 = name155() -> str @AY
    extsub @bank 155 $A009 = number155() -> ubyte @A
    extsub @bank 155 $A00c = multiply155(ubyte arg0 @A, ubyte arg1 @Y, uword arg2 @R15)
    extsub @bank 134 $A006 = name134() -> str @AY
    extsub @bank 134 $A009 = number134() -> ubyte @A
    extsub @bank 134 $A00c = multiply134(ubyte arg0 @A, ubyte arg1 @Y, uword arg3 @R15) 
    ...
    sub start() {
        ...
        txt.nl()
        txt.print_ub(number128())
        txt.nl()
        txt.print_ub(number155())
        txt.nl()
        txt.print_ub(number134())
        txt.nl()
        txt.print_ub(number128())
        txt.nl()
        ...
        ; but just a test.
        uword result
        multiply134(6,6,&result)
        txt.print_uw(result)
        txt.nl()
        multiply155(60,80,&result)
        txt.print_uw(result)
        txt.nl()
        multiply128(6,8,&result)
        txt.print_uw(result)
        txt.nl()
        ...
        txt.print("this can take 1-2 minutes on c128...\n")
